    ...
    def full_analysis(self, campaigns_data: list[dict], templates_by_campaign: dict) -> dict:
        return {
            "learnings": [
                {
                    ...
                    "loser_value": "30%",
                    "reasons": [
                        "Subject line is a question → creates curiosity",
                        "Shorter subject (5 words vs 8 words)",
                        "Personalized with {{companyName}}"
                    ]
                },
                {
                    "metric": "Reply Rate",
                    ...
                    "loser_value": "20%",
                    "reasons": [
                        "Body starts with a personalized compliment",
                        "Specific pain point mentioned (10+ hours/week)",
                        "Direct CTA with closed question"
                    ]
                },
                {
                    "metric": "Conversion Rate",
                    ...
                    "loser_value": "4%",
                    "reasons": [
                        "Message establishes more credibility",
                        "Clear value proposition from the start"
                    ]
                }
            ],
            "conclusion": "Campaign A's subject gets opens (question = curiosity), but Campaign B's body gets replies and conversions (pain point + social proof).",
            "spam_check": [
                {
                ...
                {
                    "campaign": "LinkedIn Only Campaign",
                    "status": "clean",
                    "issues": []
                }
            ],
            "optimal_campaign": {
                ...
                "why": "Combines the subject that generates the most opens + the body that generates the most replies. The subject creates curiosity, the body delivers value."
            },
            "next_ab_test": {
                "variable": "CTA Style",
                ...
                "hypothesis": "The 'case study' CTA might convert better for prospects not ready for a call, while still qualifying their interest.",
                "duration": "1 week, 100 leads per variant"
            },
            "_note": "⚠️ Demo data. Connect Gemini API for real analysis."
        }
